...
found that \rTisane's formalism removed the need for analysts to come up with
...
author their own. After observing the model's \shortquote{AIC is large, the residual is
...
and link functions in rTisane [P2, P4, P5, P9, P10, P11]. P4 explained, \shortquote{I
