...
left by how much an individual could intervene upon them \polish{(see Figure
B)}. P12's conceptual model reiterates our finding from the exploratory lab
...
their domain knowledge [P5, P10]. P13 explained, ``Identify how I may weigh
certain variables based on my general awareness and knowledge and overall
weights of each variable of how one may affect income more or less in various
...
possibilities [of expression].'' While \rTisane is not designed to prevent
...
instructions, P11 started from the \rTisane’s output model script to author
their own. After observing the model had ``poor fit'' \polish{(quote)}, they
...
Occupation, which in turn, causes Income \polish{(see Figure X)}. 
...
\polish{*Short* discussion of rTisane! GOAL: 10 sentences}
