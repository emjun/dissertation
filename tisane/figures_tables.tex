    ...
    \begin{figure}[h]
        ...
        \caption{\textbf{\rTisanes conceptual model disambiguation interface.}}
            ...
            \begin{minipage}{\linewidth}
                ...
                (C) The interface visualizes the expressed conceptual model, updating as analysts resolve ambiguities and break cycles.
            \end{minipage}
            \end{small}
...
\newcommand{\tableModelScores}{
    \begin{table}
        ...
        \begin{minipage}{\linewidth}
            ...
            When asked to author a statistical model without \rTisane, P11 took the output model from \rTisane, deemed that the model did not fit the data well based on the AIC score, log transformed the income data, and then fit the revised model as their own. 
            As a result of the log transform, many observations without an Income were dropped, explaining the difference between AIC/BIC scores without tool support and with \rTisane. 
        ...
        \begin{tabularx}{\linewidth}{p{.025\linewidth} p{.055\linewidth} >{\raggedright}p{0.53\linewidth} l l}
            ...
            \midrule \\ 
            P2                       & None       & \texttt{lm(data\$Income $\sim$ data\$Employment + data\$Age + data\$Race + data\$Education + data\$Sex + data\$Age*data\$Employment + data\$Race*data\$Employment + data\$Education*data\$Employment + data\$Sex*data\$Employment)}  & \textbf{60327741 (37)} & \textbf{60328211 (37)} \\
                                     & \rTisane   & \texttt{glm(formula=Income $\sim$ Employment, family=gaussian(link='identity'), data=data)}                                                                                                                                      & 60781341 (4)           & 60781392 (4)           \\
