...
\newcommand{\tableSummativeEvalParticipants}{
  \begin{table}[ht]
    ...
    \textbf{Participant}   &	\textbf{Field} & \textbf{Job role} & \textbf{Reported experience} & \textbf{Familiarity with GLM} & \textbf{Comfort using R} \\ 
    P1	&	& & & &	\\ 
    \end{tabular}
    \caption{Participants in summative evaluation.}
