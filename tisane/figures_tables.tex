...
\newcommand{\tableSummativeEvalParticipants}{
  \begin{table}[ht]
    ...
    \caption{\textbf{Participants in summative evaluation.}}
        \begin{small}
        \begin{minipage}{\linewidth}
            Participants came from a diversity of fields and job roles. All self-reported having significant experience with statistical analysis.
        \end{minipage}
        \end{small}
