...
\newcommand{\rTisaneProgram}{
    \lstinputlisting[
        language={}, 
        caption={Sample \rTisane program adapted from P8's in the summative evaluation. Specifying cardinality is optional with data.},
...
\newcommand{\conceptualModelDisambiguation}{
    \begin{figure}[htbp]
        ...
        \caption{\textbf{\rTisane's conceptual model disambiguation interface.} A. Options for resolving ambiguities in the conceptual model due to \relates relationships.
...
\newcommand{\statisticalModelDisambiguation}{
    \begin{figure}[htbp]
        ...
        \caption{\rTisane's statistical model disambiguation interface.}
