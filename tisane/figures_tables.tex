...
% \includegraphics{tisane/figures/figure5}
       ...
       \begin{tikzpicture}
        ...
        \end{tikzpicture}
        \caption{\polish{Suplots overlap?}Graphs demonstrating causal parents, possible causal omissions, and possible confounding associations. In graphs (a) and (b) (left and middle), all edges are causal. Independent variables are marked ``IV'', discovered candidate main effects ``CME'', dependent variables ``DV'', and causal parents ``CP''.}
...
\newcommand{\conceptualModelsScaffold}{
    \begin{figure}[htbp]
        ...
        \caption{Example conceptual models from participants in the summative evaluation without using \rTisane.}
...
\newcommand{\conceptualModelDisambiguation}{
    \begin{figure}[htbp]
        ...
        \caption{\textbf{\rTisanes conceptual model disambiguation interface.} A. Options for resolving ambiguities in the conceptual model due to \relates relationships.
...
\newcommand{\statisticalModelDisambiguation}{
    \begin{figure}[htbp]
        ...
        \caption{\rTisanes statistical model disambiguation interface.}
...
\newcommand{\tableSummativeEvalParticipants}{
  \begin{table}[ht]
        ...
        \begin{tabular}{l|l|l|l}
            ...
            \textbf{ID} & \textbf{Field} & \textbf{Role} & \textbf{Experience} \\ 
                        &                &               & \textbf{(1-10)} \\ \hline
            P1 & Statistics & Data Scientist & 9 \\ % & ~ & ~ & ~ & ~ \\ \hline
            P2 & Mechanical Engineering & Grad Student & 5 \\ % & ~ & ~ & ~ & ~ \\ \hline
            ...
            P13 & Unspecified & Unspecified & 7 \\
        \end{tabular}
    \caption{\textbf{Participants in summative evaluation.} Participants came from a diversity of fields and job roles. All self-reported having significant experience with statistical analysis.}
