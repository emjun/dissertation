...
\ej{Add program and point to lines of program?}
...
observational or experimental units from which analysts collect data. \ej{reference prog} A common
...
Measures are attributes of Units collected in a \dataSet. \ej{For example,
reference prog} Measures can be one of four types: continuous, unordered
...
unidirectional influence from a cause to an effect. \ej{Ref prog}. Internally,
...
\then parameters in the \causes and \relates functions. \ej{Ref prog}. There are
