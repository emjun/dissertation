...
The summative evaluation demonstrated that \rTisane's DSL helped analysts
...
all, these systems and evaluations are evidence for how conceptually focused
DSLs coupled with automated reasoning do lower the barriers to valid analyses.
