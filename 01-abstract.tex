...
\polish{Make sure all participant references in square brackets} \\
\polish{Check refs that should be autorefs!!} \\
\polish{Check that all figures/tables have caption + formatted consistently}
\polish{Formatting: Margins, consistency} \\
\polish{Page formatting: > Page 26 of the PDF is blank and could be removed. This recurs elsewhere in the document (for example on page 50 and page 84). It's not clear to me if this is intentional.} \\
\polish{Pass: Margins all ok} \\
\polish{make sure no space after rTisane or Tisane before '}
