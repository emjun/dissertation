...
which I call \hypoForm. I also design, implement, and evaluate two new domain-specific languages (DSLs) and
...
an improved version of \tisane in R as \rTisane, and then evaluated \rTisane in a controlled lab study.
