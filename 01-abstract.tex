...
The process of translating researchers' questions and hypotheses into low-level statistical code is error-prone.
...
a process I term \hypoForm. I also design, implement, and evaluate three new domain-specific languages (DSLs) and
...
The first of these, \tea, is used to author Null Hypothesis Significance
...
I also introduce \tisane, a system for authoring generalized linear
...
graph. \tisane traverses the graph to derive a space of statistical models based on
...
elicitation study using \tisane as a probe, designed and implemented
an improved version of \tisane as \rTisane, and then evaluated \rTisane in a controlled lab study.
