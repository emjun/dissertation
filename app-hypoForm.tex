...
\fancypagestyle{pdfpages}{
    ...
    \cfoot{\hspace{-2cm}\thepage} % Adjust to the left
    \setlength{\footskip}{200pt} % Adjust height
    \renewcommand{\headrulewidth}{0pt}
    \renewcommand{\footrulewidth}{0pt}
}
\includepdf[pages=-, fitpaper=true, scale=0.8, pagecommand={\thispagestyle{pdfpages}}]{hypothesisFormalization/annotated-matrices.pdf} 