...
to infer a statistical model. Additionally, \tisane's DSL \polish{define SDSL? reuse SDSL long?} provides conceptual
...
widely usable. \polish{Sentence doesn't parse for me. Revise: However, \tea and \tisane differ from AutoML efforts in their
researchers developing scientific theories.} As a result, \tisane focuses
