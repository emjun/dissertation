...
\newcommand{\tableSoftwareAnalysis}{
    \begin{table*}
        ...
        % \begin{tabular}{l>{\raggedright}p{0.15\linewidth}p{0.15\linewidth}p{0.15\linewidth}p{0.15\linewidth}p{0.2\linewidth}}
...
\newcommand{\figurePriorWorkCombined}{
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.95\textwidth]{hypothesisFormalization/figures/prior_work_combined_july_16_2021.png}
