...
\newcommand{\figureOverivew}{
    \begin{figure}[t]
        \centering
        \includegraphics[width=.9\textwidth]{hypothesisFormalization/figures/overview_sept_17.png}
        \caption{\textbf{Definition and overview of the hypothesis formalization
        steps and process.}\label{figure:overview}}
        \begin{small}
        \begin{minipage}{\linewidth}
...
\newcommand{\figurePriorWorkCombined}{
    \begin{figure}
        ...
        differentiates them. As a whole, this paper provides empirical evidence for
        theorized loops between conceptual hypothesis and statistical
        specification (see Figure~\ref{figure:overview}).
        \end{minipage}
        \end{small}
        \vspace*{-15pt}
      \end{figure}
