...
\newcommand{\figureExampleReorderableMatrix}{
    \begin{figure}
        ...
        \caption{\textbf{Formative content analysis: Example reorderable matrix for Ngo et al.'s 
        ``Development of holistic episodic recollection'' published in \textit{Psychological Science} (2019)
        ~\cite{PS9}.}\label{figure:exampleReorderableMatrix}}
        \begin{small}
            \begin{minipage}{\linewidth}
            %
            \polish{Figure easier to read, lable is readable text}
