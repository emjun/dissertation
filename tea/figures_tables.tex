...
\begin{figure}
    % \vspace{-5pt}
    \centering
    \includegraphics[width=1.\columnwidth, clip]{tea/figures/tea_program.jpg}
    % \vspace{-15pt} 
    ...
    See~\autoref{sec:usagescenario} for an explanation of the code. Tea programs specify 1) data, 2) variables, 3) study design, 4) assumptions, and 5) hypotheses.}
...
\newcommand{\otherSystems}{
    \begin{table*}[t]
        \centering \small
        \caption{\textbf{Comparison of Tea to other tools.} Despite the published best practices for statistical analyses, most tools do not help users select appropriate tests. Tea not only addresses the best practices but also supports reproducing analyses.}
