...
abstraction is high or low is less relevant than if the abstraction is a the
...
evaluation, reflection throughout analysis can also deepen domain thinking and
...
By addressing each of core challenges, the DSLs and automated reasoning
approaches in this dissertation makes it possible for statistical non-experts to
...
evaluation. \tisane and \rTisane doe not yet provide support for analysts to
...
started to iterate on \rTisane's output statistical model and sought more
...
for construct validity was in having access to and incorporating a knowledge
...
\subsection{Support the larger data life-cycle}
...
regardless of statistical background, reliably analyze data to guide discovery
