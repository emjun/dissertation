...
the data is a form of ``double-dipping,'' or using the data to make
decisions about analyses on the data. Preventing this would be ideal to reduce
the false positive discovery rate~\cite{fithian2014optimal,taylorTibshirani2015statistical}. However, the statistics community is still
...
technique, data fission~\cite{leiner2023dataFission} overcomes, in theory, this dependence on dataset
