...
\subsection{Challenge 2: Represent and reason about key statistical analysis decisions} %- programming
...
\subsection{Challenge 3: Increase analysts' statistical knowledge/understanding} %- statistics
...
\subsection{Summary of Contributions} \todo{Update this section}
...
\paragraph{How to approach this dissertation} \todo{Decide if want to keep}

\subsection{Prior Publication and Authorship} \todo{fill in}