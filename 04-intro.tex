...
\section*{Challenge 1: Make implicit domain knowledge explicit} %- domain knowledge
...
evaluation of the key tenets of this dissertation. \textcolor{orange}{Revisit: This chapter concludes with a
...
AI-driven code generation create new opportunities to make data analysis authoring valid
by design and more approachable (\autoref{sec:futureWork}). \textcolor{orange}{Revisit: Add another sentence here emphasizing key contributions?}
